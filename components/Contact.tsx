        ...
        <div className="contact__layer">
          ...
          <div className="contact__main">
            <nav className="contact__nav">
              ...
              <a href="/#work" className="contact__nav-link">
                Work
              </a>
            ...
            <form className="contact__form" onSubmit={sendMessage}>
              {inputNameFocus && (
                <label
                  className="label-input label-input-name"
                  htmlFor="input-name"
                >
                  Your name
                </label>
              ...
              <input
                ...
                className={
                  inputNameDirty
                    ? "contact__input contact__input-visited"
                    : "contact__input"
                }
                required
                type="text"
              ...
              {inputEmailFocus && errorEmail ? (
                <label
                  className="label-input label-input-email label-error"
                  htmlFor="input-email"
                >
                  Your email/error
                </label>
                ...
                inputEmailFocus && (
                  <label
                    className="label-input label-input-email"
                    htmlFor="input-email"
                  >
                    Your email
                  </label>
              ...
              <input
                ...
                className={
                  inputEmailDirty && errorEmail
                    ? "contact__input contact__input-visited input-error-email"
                    : inputEmailDirty
                    ? "contact__input contact__input-visited"
                    : "contact__input"
                }
              ...
              {inputYourCompanyFocus && (
                <label
                  className="label-input label-input-your-company"
                  htmlFor="input-your-company"
                >
                  Your company
                </label>
              )}
              ...
              <textarea
                ...
                className={
                  textareaDirty
                    ? "contact__textarea contact__textarea-visited"
                    : "contact__textarea"
                }
                required
